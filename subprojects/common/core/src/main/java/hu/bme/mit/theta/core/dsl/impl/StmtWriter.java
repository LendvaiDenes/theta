...
public class StmtWriter implements StmtVisitor<Void, String> {
	...
	@Override
	public String visit(AtMostStmt stmt, Void param) { throw new UnsupportedOperationException(); }

	@Override
	public String visit(ExactlyStmt exactlyStmt, Void param) { throw new UnsupportedOperationException(); }
