...
public final class ClockOps {
	...
	private static final class StmtToClockOpVisitor implements StmtVisitor<Void, ClockOp> {
		...
		@Override
		public ClockOp visit(AtMostStmt atMostStmt, Void param) { throw new UnsupportedOperationException(); }

		@Override
		public ClockOp visit(ExactlyStmt exactlyStmt, Void param) { throw new UnsupportedOperationException(); }
